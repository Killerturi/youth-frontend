    ...
    <AnimatePresence>
      {selectedCourse && (
        ...
        >
          ...
          >
            {/* ================= STICKY HEADER ================= */}
            <div
              className={`sticky top-0 z-20 bg-white px-6 md:px-8 pt-6 pb-5 border-b transition ${
      ...
      mb-4"
              ...
              <div className="mt-10 border-t pt-6 text-sm text-gray-600 space-y-2">
                ...
                <p>✔ Strong Foundation & Concept Clarity</p>
                <p>✔ Industry-Recognized Certificate</p>
                {selectedCourse.features?.careerSupport && (
